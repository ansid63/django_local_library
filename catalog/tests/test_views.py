...
class AuthorCreateTest(TestCase):
    ...
    def setUp(self):
        # author = Author.objects.create(first_name='Lev', last_name='Tolstoy', date_of_birth='1800-01-01',
        #                                   date_of_death='1900-01-10', )
        #  Создание пользователя
        test_user1 = User.objects.create_user(username='testuser1', password='12345')
        test_user1.save()
        permission = Permission.objects.get(name='Set book as returned')
    ...
    def test_redirects_to_all_authors_on_success(self):
        ...
        resp = self.client.post(reverse('author_create'), {'first_name': 'Tolstoy', 'last_name': 'Tolstoy',
